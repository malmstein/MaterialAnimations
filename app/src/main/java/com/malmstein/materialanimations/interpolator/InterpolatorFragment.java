...
package com.malmstein.materialanimations.interpolator;
...
public class InterpolatorFragment extends Fragment {
     ...
     * {@link android.view.View#SCALE_X} and {@link android.view.View#SCALE_Y} properties, with its animation based on a path.
